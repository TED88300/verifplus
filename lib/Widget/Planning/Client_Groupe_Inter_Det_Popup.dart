...
class Client_Groupe_Inter_Det_Popup extends StatefulWidget {
  final bool bFact;
  final String wChamps;
  const Client_Groupe_Inter_Det_Popup({Key? key, required this.bFact, required this.wChamps}) : super(key: key);

  @override
  _Client_Groupe_Inter_Det_PopupState createState() => _Client_Groupe_Inter_Det_PopupState();
}

class _Client_Groupe_Inter_Det_PopupState extends State<Client_Groupe_Inter_Det_Popup> {
  String wTitle = "";
        ...
        children: <Widget>[
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              Srv_DbTools.setZone(Srv_DbTools.gZone);
