...
//    Widget wAide_Ico = gObj.getAssetImage("assets/images/Ico.png"),
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.param_Saisie.Param_Saisie_Controle) {
      case "Poids":
        ...
        print("Poids ${wDialogHeight} nbL ${nbL}");
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return InkWell(
                                    onTap: () async {
                                      ...
                                      print("scrollController DbTools.gParc_Ent.Parcs_CODF $index ${DbTools.gParc_Ent.Parcs_CODF}");
                                    ...
                                    child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                                item.NF074_Histo_Normes_SORT_AAAA.length == 1 ?
                                            ...
                                            Text("${item.NF074_Gammes_GAM}, ${item.NF074_Gammes_PRS}, ${item.NF074_Gammes_CLF}",
                                                textAlign: TextAlign.left,
                                                style: gColors.bodyTitle1_N_Gr.copyWith(
                                                  color: gColors.primary,
                                                )),
        ...
        children: <Widget>[
          ...
          new ElevatedButton(
            onPressed: () async {
              ...
              if (widget.parc_Desc.ParcsDesc_Type!.compareTo("DESC") == 0) {Srv_DbTools.DESC_Lib = widget.parc_Desc.ParcsDesc_Lib!;}
              if (widget.parc_Desc.ParcsDesc_Type!.compareTo("FAB") == 0) {Srv_DbTools.FAB_Lib = widget.parc_Desc.ParcsDesc_Lib!;}
              if (widget.parc_Desc.ParcsDesc_Type!.compareTo("PRS") == 0) {Srv_DbTools.PRS_Lib = widget.parc_Desc.ParcsDesc_Lib!;}
              if (widget.parc_Desc.ParcsDesc_Type!.compareTo("CLF") == 0) {Srv_DbTools.CLF_Lib = widget.parc_Desc.ParcsDesc_Lib!;}
              if (widget.parc_Desc.ParcsDesc_Type!.compareTo("MOB") == 0) {Srv_DbTools.MOB_Lib = widget.parc_Desc.ParcsDesc_Lib!;}
              if (widget.parc_Desc.ParcsDesc_Type!.compareTo("PDT") == 0) {Srv_DbTools.PDT_Lib = widget.parc_Desc.ParcsDesc_Lib!;}
              if (widget.parc_Desc.ParcsDesc_Type!.compareTo("POIDS") == 0) {Srv_DbTools.POIDS_Lib = widget.parc_Desc.ParcsDesc_Lib!;}
              if (widget.parc_Desc.ParcsDesc_Type!.compareTo("GAM") == 0) {Srv_DbTools.GAM_Lib = widget.parc_Desc.ParcsDesc_Lib!;}
  ...
  Widget Poids(BuildContext context) {
    ...
    print(">>>>>>>>>>>>>>>>>> Poids  wUnit ${wUnit} ${widget.parc_Desc.ParcsDesc_Lib!}");

    Srv_DbTools.ListParam_Saisie_Param.forEach((element) {
      BtnCards.add(BtnCardPoids(element.Param_Saisie_Param_Label, wUnit, element.Param_Saisie_Param_Id, element.Param_Saisie_Param_Label.compareTo(wPoids) == 0));
    ...
    print("POIDS $wUnit ${Srv_DbTools.wKgL} ${Srv_DbTools.wKgL.length == 0}");
