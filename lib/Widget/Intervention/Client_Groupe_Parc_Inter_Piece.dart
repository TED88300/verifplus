...
class Client_Groupe_Parc_Inter_Piece extends StatefulWidget {
  final VoidCallback onMaj;
  final String x_t;

  const Client_Groupe_Parc_Inter_Piece({Key? key, required this.onMaj, required this.x_t}) : super(key: key);
...
//    lParcs_Art.addAll(wlParcs_Art);
    ...
    for (int ii = 0; ii < wlparcsArt.length; ii++) {
      Parc_Art element = wlparcsArt[ii];
