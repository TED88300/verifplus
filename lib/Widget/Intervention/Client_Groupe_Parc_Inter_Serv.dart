...
class Client_Groupe_Parc_Inter_Serv extends StatefulWidget {
  final VoidCallback onMaj;
  final String x_t;

  const Client_Groupe_Parc_Inter_Serv({Key? key, required this.onMaj, required this.x_t}) : super(key: key);
...
class Client_Groupe_Parc_Inter_ServState extends State<Client_Groupe_Parc_Inter_Serv> with AutomaticKeepAliveClientMixin{
  ...
  Future initLib() async {
    ...
    List<Parc_Art> wlparcsArt = await DbTools.getParcs_Art_AllType(DbTools.gParc_Ent.ParcsId!);
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await Client_Groupe_Parc_Inter_Article_Dialog.Dialogs_Saisie(context,  onSaisie, "Serv");
