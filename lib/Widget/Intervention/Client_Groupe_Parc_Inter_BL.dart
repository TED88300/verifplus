...
class Client_Groupe_Parc_Inter_BL extends StatefulWidget {
  ...
  const Client_Groupe_Parc_Inter_BL({Key? key, required this.onMaj, required this.x_t}) : super(key: key);

  @override
  Client_Groupe_Parc_Inter_BLState createState() => Client_Groupe_Parc_Inter_BLState();
}

class Client_Groupe_Parc_Inter_BLState extends State<Client_Groupe_Parc_Inter_BL> {
  ...
  Future initLib() async {
    ...
    List<Parc_Art> wlparcsArt = await DbTools.getParcs_ArtInterSumBL(Srv_DbTools.gIntervention.InterventionId);
  ...
  void Filtre() async {
    ...
    if (filterText.isEmpty) {
      ...
      for (int jj = 0; jj < DbTools.lParcs_Art.length; jj++) {
        ...
        if(wparcArt.Desc().contains(filterText)) {
          searchParcs_Art.add(wparcArt);
        }
      }
    }
    setState(() {});
  ...
  Widget build(BuildContext context) {
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  await Navigator.push(context, MaterialPageRoute(builder: (context) => const Aff_BL()));
                },
      ...
      body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              (searchParcs_Art.isEmpty ) ? Container() :
              Expanded(
   ...
   Widget InterventionTitleWidget2() {
    return Material(
      elevation: 4,
      child: Container(
        width: 640,
