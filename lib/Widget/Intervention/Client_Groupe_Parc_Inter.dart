...
class Client_Groupe_Parc_Inter extends StatefulWidget {
  const Client_Groupe_Parc_Inter({super.key});
...
//******************************
      ...
      String parcsdescTypeFab = "";
      String parcsdescTypeGam = "";
      ...
      for (int jjj = 0; jjj < DbTools.glfParcs_Desc.length; jjj++) {
        ...
        if (elementEnt.ParcsId == element2.ParcsDesc_ParcsId) {
          ...
          if (element2.ParcsDesc_Type!.compareTo("FAB") == 0) {
            parcsdescTypeFab = element2.ParcsDesc_Lib!;
          }
          if (element2.ParcsDesc_Type!.compareTo("GAM") == 0) {
            parcsdescTypeGam = element2.ParcsDesc_Lib!;
          }
        }
      }
...
//        if (ParcsDesc_Type_Ech.compareTo("---") == 0) elementEnt.Parcs_VRMC = "REF";
        ...
        elementEnt.Parcs_VRMC = "---";
      elementEnt.Parcs_Date_Desc2 = "$parcsdescTypeFab / $parcsdescTypeGam";
    ...
    elementEnt.Parcs_Img = "";
      ...
      if (btnSel_Aff) {
        if (DbTools.glfParc_Imgs.isNotEmpty) {
          var parcImg = DbTools.glfParc_Imgs[0];
          elementEnt.Parcs_Img = parcImg.Parc_Imgs_Data!;
...
//                      print("♦︎♦︎ IMPORT ♦︎♦︎ ListParc_Ent ${xParc_Ent_Srv.Parcs_InterventionId} ${xParc_Ent_Srv.Parcs_order}");
                    ...
                    print("***************** DELETE getParcs_ArtInter ${wparcsArt.length}");
                    ...
                    print("***************** DELETE getParcs_ArtInterSO ${wparcsArt.length}");
                    for (int i = 0; i < wparcsArt.length; i++) {
                      Parc_Art xparcArt = wparcsArt[i];
                      await DbTools.deleteParc_Art(xparcArt.ParcsArtId!);
                    }
                    ...
                    List<Parc_Art> zparcsArtso = await DbTools.getParcs_ArtInterSO(Srv_DbTools.gIntervention.InterventionId);
...
*/
                        ...
                        "- ${zparcsArt.length + zparcsArtso.length} Articles\n"
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (DbTools.gRowSels.length == 1 || DbTools.gRowSels.length == 2) {
                        ...
                        for (int i = 0; i < NbAdd; i++) {
                          print("Aprés C");
                          Parc_Ent wparcEnt = Parc_Ent.Parc_EntInit(Srv_DbTools.gIntervention.InterventionId, DbTools.gParc_Ent.Parcs_Type!, DbTools.gParc_Ent.Parcs_order! + i + 1);
                          DbTools.insertParc_Ent(wparcEnt);
                        }
                        Reload();
                      }
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      Parc_Ent dparcsEnt = DbTools.lParcs_Ent[index];
                      Color wColor = Colors.transparent;

                      Color wColorBack2 = Colors.white;
                      Color wColorText = Colors.black;
                      if (LastClickID == dparcsEnt.ParcsId) wColorText = Colors.white;

                      if (DbTools.gRowisSel && isInSels(dparcsEnt.ParcsId!)) {
                      ...
                      return Column(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: LastClickID == dparcsEnt.ParcsId ? gColors.backgroundColor : gColors.transparent,
                            ),
                            child: Stack(
                              fit: StackFit.expand,
                              children: <Widget>[
                                Container(
                                  color: Colors.white,
                                  child: GestureDetector(
                                    onLongPress: () => _onSelMove(dparcsEnt),
                                    onTap: () => _onRowDoubleTap(context, dparcsEnt),
                                    child: Column(children: [
                                      btnSel_Aff
                                          ? Container(
                                              width: 800,
                                              color: LastClickID == dparcsEnt.ParcsId ? gColors.backgroundColor : gColors.white,
                                              height: rowh,
                                              child: Row(
                                                mainAxisAlignment: MainAxisAlignment.start,
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: <Widget>[
                                                  ...
                                                  Container(
                                                    color: DbTools.gRowisSel && isInSels(dparcsEnt.ParcsId!) ? gColors.GrdBtn_Colors1Sel : gColors.transparent,
                                                    child:
                                                    Row(children: [
                                                      // N°
                                                      Container(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                                                                ...
                                                                SizedBox(
                                                                    width: 30,
                                                                    height: rowh,
                                                                    child: (dparcsEnt.Parcs_UUID_Parent!.isNotEmpty)
                                                                        ? SvgPicture.asset(
                                                                      "assets/images/Ico_MS.svg",
                                                                      height: 0,
                                                                      width: 30,
                                                                      color: dparcsEnt.Livr!.isNotEmpty ? Colors.red : LastClickID == dparcsEnt.ParcsId ? Colors.white : Colors.black,
                                                                    )
                                                                        : Text(
                                                                      "${dparcsEnt.Parcs_order}",
                                                                      textAlign: TextAlign.right,
                                                                      style: dparcsEnt.Livr!.isNotEmpty ? gColors.bodySaisie_B_O.copyWith(color: LastClickID == dparcsEnt.ParcsId ? Colors.white : null) : gColors.bodySaisie_B_G.copyWith(color: LastClickID == dparcsEnt.ParcsId ? Colors.white : wColorText),
                                                                    )),
                                                              ]),
                                                            ),
                                                            onTap: () async {
                                                              print("Selection");
                                                              if (LastClickID == dparcsEnt.ParcsId) {
                                                                LastClickID = -1;
                                                              } else {
                                                                LastClickID = dparcsEnt.ParcsId!;
                                                              }
                                                      ...
                                                      SizedBox(
                                                        ...
                                                        child: InkWell(
                                                            child: Container(
                                                              ...
                                                              width: 75,
                                                              height: 75,
                                                              child: dparcsEnt.Parcs_ImgWidget,
                                                            ),
                                                            onTap: () async {
                                                              print("Selection");
                                                              if (LastClickID == dparcsEnt.ParcsId) {
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                                                            Container(
                                                                padding: const EdgeInsets.only(left: 5, right: 5),
                                                                child: Text(
                                                                  "${dparcsEnt.Parcs_Date_Desc2}",
                                                                  textAlign: TextAlign.right,
                                                                  style: dparcsEnt.Livr!.isNotEmpty ? gColors.bodySaisie_N_O.copyWith(color: LastClickID == dparcsEnt.ParcsId ? Colors.white : null) : gColors.bodySaisie_N_G.copyWith(color: LastClickID == dparcsEnt.ParcsId ? Colors.white : wColorText),
                                                                ))
                                                          ]),
                                                        ),
                                                        SizedBox(
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                                                            Container(
                                                                padding: const EdgeInsets.only(left: 5, right: 5),
                                                                child: Text(
                                                                  dparcsEnt.Parcs_Date_Rev!.isEmpty ? '' : DateFormat('dd/MM/yy').format(DateTime.parse(dparcsEnt.Parcs_Date_Rev!)),
                                                                  textAlign: TextAlign.right,
                                                                  style: dparcsEnt.Livr!.isNotEmpty ? gColors.bodySaisie_B_O.copyWith(color: LastClickID == dparcsEnt.ParcsId ? Colors.white : null) : gColors.bodySaisie_B_G.copyWith(color: LastClickID == dparcsEnt.ParcsId ? Colors.white : wColorText),
                                                                ))
                                                          ]),
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Row(mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                                                            Container(
                                                              padding: const EdgeInsets.only(left: 5, right: 5),
                                                              child: Container(
                                                                child: dparcsEnt.Parcs_VRMC!.isEmpty ? Container() : Text("${dparcsEnt.Parcs_VRMC} >", textAlign: TextAlign.right, style: dparcsEnt.Livr!.isNotEmpty ? gColors.bodySaisie_B_O.copyWith(color: LastClickID == dparcsEnt.ParcsId ? Colors.white : null) : gColors.bodySaisie_B_G.copyWith(color: LastClickID == dparcsEnt.ParcsId ? Colors.white : Colors.green)),
                                                              ),
                                                            )
                                                          ]),
                                                        )
                                      ...
                                      Container(
                                        height: 1,
                                        color: LastClickID == dparcsEnt.ParcsId ? gColors.backgroundColor : gColors.LinearGradient2,
                                      ),
