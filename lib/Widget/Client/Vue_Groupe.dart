...
import 'package:verifplus/Widget/Client/Vue_Groupe_Popup.dart';
...
class _Groupe_VueState extends State<Groupe_Vue> {
  bool bFact = true;
...
//            await Navigator.push(context, MaterialPageRoute(builder: (context) => Client_Vue_Edit()));
  ...
  Widget AffBtnAdd(String wChamps) {
    return TextButton(
        ...
        onPressed: () async {
          print("onPressed AffBtnAdd  ${Srv_DbTools.gClient.ClientId} ${Srv_DbTools.gGroupe.GroupeId}");
          await Srv_DbTools.addContactAdrType(Srv_DbTools.gClient.ClientId, Srv_DbTools.gGroupe.GroupeId, "GRP");
          await Srv_DbTools.getContactGrp(Srv_DbTools.gClient.ClientId, Srv_DbTools.gGroupe.GroupeId);
