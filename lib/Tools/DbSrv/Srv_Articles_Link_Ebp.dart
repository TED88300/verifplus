...
//
  ...
  static Article_Link_EbpInit() {
    return Article_Link_Ebp(0, "", "","","", "", "", "", "", "");
  }
  Article_Link_Ebp(int    Articles_LinkId,
      String Articles_Link_ParentID,
      String Articles_Link_TypeChildID,
      String Articles_Link_ChildID,
      String Articles_Link_Qte,
    ...
    this.Articles_Link_DnID	       =  Articles_Link_DnID;
    this.Articles_Link_DnQte	       =  Articles_Link_DnQte;
    this.Articles_Link_NewInv	       =  Articles_Link_NewInv;
  }

  factory Article_Link_Ebp.fromJson(Map<String, dynamic> json) {
//    print("json $json");
    Article_Link_Ebp warticlesLinkEbp = Article_Link_Ebp(
