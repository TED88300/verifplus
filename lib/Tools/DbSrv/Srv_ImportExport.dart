...
class Srv_ImportExport {
  ...
  static Future<bool> Client_Export_Insert(Client wClient) async {
    ...
    print(
        "Client à remonter INSERT  ${wClient.Client_Nom} ${wClient.ClientId}");
    bool wRes = await Srv_DbTools.addClient(wClient);
    if (wRes) {
      wClient.ClientId = Srv_DbTools.gLastID;
      newClientId = Srv_DbTools.gLastID;
      print(
          "Client à remonter INSERT OK ${wClient.Client_Nom} >>>> ${wClient.ClientId}");
  ...
  static Future<bool> Groupe_Export_Insert(Groupe wGroupe) async {
    ...
    if (wRes) {
      ...
      print(
          "Groupe_Export_Insert OK ${wGroupe.Groupe_Nom} >>>> ${wGroupe.GroupeId}");
  ...
  static Future<bool> Intervention_Export_Insert(
      Intervention wIntervention) async {
    int oldID = wIntervention.InterventionId;
    print(
        "Intervention_Export_Insert A ${wIntervention.Intervention_Type} ${wIntervention.InterventionId}");
    ...
    print(
        "Intervention_Export_Insert updateInterventions ${wIntervention.Intervention_Type} >> ${wIntervention.Intervention_ZoneId}  >> ${wIntervention.InterventionId}");
    return wRes;
  }

  // ☀︎☀︎☀︎ ADRESSE INSERT ☀︎☀︎☀︎
  static Future<bool> Adresse_Export_Insert(
      Client wClient, int saveClientId, String wType) async {
    ...
    print(
        "Adresse à remonter INSERT  ${wAdresse.Adresse_Adr1} ${wAdresse.AdresseId}");
  ...
  static Future<bool> Contact_Export_InsertUpdate(
      int wClientId, int saveClientId, String wType) async {
    ...
    for (int i = 0; i < Srv_DbTools.ListContact.length; i++) {
      ...
      if (!wContact.Contact_isUpdate && wContact.ContactId >= 0) {
        ...
        print(
            "Contact à remonter INSERT  ${wContact.Contact_Nom} ${wContact.ContactId}");
        bool wRes = await Srv_DbTools.addContactAdrType(
            saveClientId, saveAdresseId, wType);
        if (wRes) {
  ...
  static Future<bool> Contact_Export_Insert(
      int wClientId, int saveClientId, String wType) async {
    ...
    print(
        "Contact à remonter INSERT  ${wContact.Contact_Nom} ${wContact.ContactId}");
    bool wRes =
        await Srv_DbTools.addContactAdrType(saveClientId, saveAdresseId, wType);
    if (wRes) {
      wContact.ContactId = Srv_DbTools.gLastID;
      wContact.Contact_ClientId = wClientId;
      wContact.Contact_AdresseId = AdresseId;
  ...
  static Future ExportNotSync() async {
    ...
    for (int i = 0; i < Srv_DbTools.ListClient.length; i++) {
      ...
      // ☀︎☀︎☀︎ CLIENT INSERT ☀︎☀︎☀︎
        ...
        if (wRes) {
          ...
          bool wRes =
              await Adresse_Export_Insert(wClient, saveClientId, "FACT");
          // ☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎
          // ☀︎☀︎☀︎ CONTACT CLIENT INSERT FACT ☀︎☀︎☀︎
          // ☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎
          if (wRes) {
            bool wRes = await Contact_Export_Insert(
                wClient.ClientId, saveClientId, "FACT");
          }
          ...
          if (wRes) {
            bool wRes = await Contact_Export_Insert(
                wClient.ClientId, saveClientId, "LIVR");
          }
          ...
          if (wRes) {
            ...
            for (int ig = 0; ig < Srv_DbTools.ListGroupe.length; ig++) {
              ...
              if (!wGroupe.Groupe_isUpdate && wGroupe.GroupeId >= 0) {
                ...
                await Contact_Export_Insert(
                    wClient.ClientId, saveGroupeId, "SITE");

                Srv_DbTools.ListSite =
                    await DbTools.getSiteGroupe(saveGroupeId);
                  ...
                  if (!wSite.Site_isUpdate && wSite.SiteId >= 0) {
                    ...
                    for (int iz = 0; iz < Srv_DbTools.ListZone.length; iz++) {
                      ...
                      if (!wZone.Zone_isUpdate && wZone.ZoneId >= 0) {
                        ...
                        await Contact_Export_Insert(
                            wClient.ClientId, saveGroupeId, "ZONE");

                        // ☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎
                        // ☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎ INTERVENTION  ☀︎☀︎☀︎☀︎☀︎
                        // ☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎☀︎

                        Srv_DbTools.ListIntervention =
                            await DbTools.getInterventions(saveZoneId);
                        for (int ii = 0;
                            ii < Srv_DbTools.ListIntervention.length;
                            ii++) {
                          Intervention wIntervention =
                              Srv_DbTools.ListIntervention[ii];
                          if (!wIntervention.Intervention_isUpdate &&
                              wIntervention.InterventionId >= 0) {
                            bool wRes =
                                await Intervention_Export_Update(wIntervention);
                          } else if (!wIntervention.Intervention_isUpdate &&
                              wIntervention.InterventionId < 0) {
                            bool wRes =
    ...
    print(
        "Contact Srv_DbTools.ListContact.length ${Srv_DbTools.ListContact.length}");
    ...
    for (int i = 0; i < Srv_DbTools.ListGroupe.length; i++) {
      ...
      if (!wGroupe.Groupe_isUpdate && wGroupe.GroupeId >= 0) {
        ...
        print(
            "••••• ••••• ••••• ••••• BOUCLE GROUPE ${wGroupe.GroupeId} ${wGroupe.Groupe_ClientId}");
        ...
        print(
            "••••• ••••• ••••• ••••• BOUCLE GROUPE  getSiteGroupe ${Srv_DbTools.ListSite.length}");
        for (int isi = 0; isi < Srv_DbTools.ListSite.length; isi++) {
          Site wSite = Srv_DbTools.ListSite[isi];
          if (!wSite.Site_isUpdate && wSite.SiteId >= 0) {
            bool wRes = await Site_Export_Update(wSite);
            ...
            print(
                "••••• ••••• ••••• ••••• BOUCLE GROUPE  getZones");
            Srv_DbTools.ListZone = await DbTools.getZones(saveSiteId);
            print(
                "••••• ••••• ••••• ••••• BOUCLE GROUPE  getZones ${Srv_DbTools.ListZone.length}");
            for (int iz = 0; iz < Srv_DbTools.ListZone.length; iz++) {
              Zone wZone = Srv_DbTools.ListZone[iz];
              if (!wZone.Zone_isUpdate && wZone.ZoneId >= 0) {
                bool wRes = await Zone_Export_Update(wZone);
                ...
                bool wRes = await Zone_Export_Insert(wZone);
                await Contact_Export_Insert(
                    wGroupe.Groupe_ClientId, saveGroupeId, "ZONE");
    ...
    for (int i = 0; i < Srv_DbTools.ListSite.length; i++) {
      ...
      if (!wSite.Site_isUpdate && wSite.SiteId >= 0) {
        ...
        print(
            "••••• ••••• ••••• ••••• BOUCLE SITE ${wSite.SiteId} ${wSite.Site_GroupeId}");
        ...
        for (int iz = 0; iz < Srv_DbTools.ListZone.length; iz++) {
          ...
          if (!wZone.Zone_isUpdate && wZone.ZoneId >= 0) {
            print(
                "••••• ••••• ••••• ••••• BOUCLE SITE : Zone_Export_Update ${wZone.ZoneId}");
            bool wRes = await Zone_Export_Update(wZone);
    ...
    for (int iz = 0; iz < Srv_DbTools.ListZone.length; iz++) {
      ...
      if (!wZone.Zone_isUpdate && wZone.ZoneId >= 0) {
        print(
            "••••• ••••• ••••• ••••• BOUCLE ZONE : Zone_Export_Update ${wZone.ZoneId}");
        bool wRes = await Zone_Export_Update(wZone);
        int wClientID = await DbTools.getClient_ID_Site(wZone.Zone_SiteId);
        print(
    ...
    for (int i = 0; i < Srv_DbTools.ListIntervention.length; i++) {
      ...
      if (!wIntervention.Intervention_isUpdate &&
        ...
        bool wRes = await Intervention_Export_Update(wIntervention);
          ...
          wIntervention.InterventionId < 0) {
        print(
            "••••• ••••• ••••• ••••• BOUCLE INTERVENTION ${wIntervention.Intervention_ZoneId}");
...
//                    await Srv_DbTools.delParc_Ent_Srv(Srv_DbTools.gIntervention.InterventionId!);
  ...
  static Future<bool> ImportClient() async {
    ...
    if (wResult) {
      ...
      Srv_DbTools.ListClient = await DbTools.getClientsAll();
      print(
          "Import_DataDialog ON LINE Srv_DbTools.ListClient  ${Srv_DbTools.ListClient}");
      return true;
    }
    Srv_DbTools.ListClient = await DbTools.getClientsAll();
    print(
        "Import_DataDialog OFF LINE Srv_DbTools.ListClient ${Srv_DbTools.ListClient}");
    return false;
  }
  ...
  static Future<bool> ImportAdresse() async {
    ...
    if (wResult) {
      ...
      Srv_DbTools.ListAdresse = await DbTools.getAdresseAll();
      print(
          "Import_DataDialog Srv_DbTools.ListAdresse ${Srv_DbTools.ListAdresse.length}");
      return true;
    }
    Srv_DbTools.ListAdresse = await DbTools.getAdresseAll();
    print(
  ...
  static Future<bool> ImportPlanning() async {
    ...
    if (wResult) {
      ...
      print(
          "Import_DataDialog Srv_DbTools.ListPlanning ${Srv_DbTools.ListPlanning.length}");
      return true;
    }
    Srv_DbTools.ListPlanning = await DbTools.getPlanningAll();
    print(
  ...
  static Future<bool> ImportPlanning_Intervention() async {
    bool wResult = await Srv_DbTools.getPlanning_InterventionRes(
        Srv_DbTools.gUserLogin.User_Matricule);
...
//    print("ImportPlanning_Intervention Import ${Srv_DbTools.ListPlanning_Intervention.length}");
    ...
    if (wResult) {
      ...
      print(
          "ImportPlanning_Intervention Srv_DbTools.ListPlanning_Intervention ${Srv_DbTools.ListPlanning_Intervention.length}");
      return true;
    }
    Srv_DbTools.ListPlanning_Intervention =
        await DbTools.getPlanning_InterventionAll();
    print(
        "Import_DataDialog Srv_DbTools.ListPlanning ${Srv_DbTools.ListPlanning_Intervention.length}");
    return false;
  }

  static Future<bool> ImportInterMission() async {
    bool wResult = await Srv_DbTools.getInterMissionUID(
        Srv_DbTools.gUserLogin.User_Matricule);
    print(
        "••••••••••••• Import_DataDialog  ${Srv_DbTools.gUserLogin.User_Matricule} ListInterMissions ${Srv_DbTools.ListInterMission.length}");
    ...
    if (wResult) {
      ...
      print(
          "••••••••••••• Import_DataDialog Srv_DbTools.ListInterMissions ${Srv_DbTools.ListInterMission.length}");
      return true;
    }
  ...
  static Future<bool> ImportIntervention() async {
    bool wResult = await Srv_DbTools.getInterventionUID(
        Srv_DbTools.gUserLogin.User_Matricule);
    print(
        "Import_DataDialog ListInterventions ${Srv_DbTools.ListIntervention.length}");
    ...
    if (wResult) {
      ...
      Srv_DbTools.ListIntervention = await DbTools.getInterventionsAll();
      print(
          "Import_DataDialog Srv_DbTools.ListInterventions ${Srv_DbTools.ListIntervention.length}");
      return true;
    }
