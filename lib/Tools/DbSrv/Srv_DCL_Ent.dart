class DCL_Ent {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['DCL_Ent_Num'] = this.DCL_Ent_Num;
    ...
    data['DCL_Ent_PrefAff'] = this.DCL_Ent_PrefAff;
    data['DCL_Ent_RelAuto'] = this.DCL_Ent_RelAuto;
  ...
  static DCL_Ent fromMap(Map<String, dynamic> map) {
    return DCL_Ent(
      ...
      DCL_Ent_PrefAff: map["DCL_Ent_PrefAff"],
      DCL_Ent_RelAuto: map["DCL_Ent_RelAuto"],
