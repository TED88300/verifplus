...
//    print("getDatabasesPath() $wgetDatabasesPath");
    ...
    String wcreateParamSaisieParam = "CREATE TABLE Param_Saisie_Param (Param_Saisie_ParamId INTEGER NOT NULL, "
    ...
    String wcreateUsersDesc = "CREATE TABLE User_Desc (User_DescID INTEGER NOT NULL, User_Desc_UserID INTEGER NOT NULL, User_Desc_Param_DescID INTEGER NOT NULL, User_Desc_MaintPrev INTEGER NOT NULL, User_Desc_Install INTEGER NOT NULL, User_Desc_MaintCorrect INTEGER NOT NULL, User_Desc_Ordre INTEGER NOT NULL DEFAULT 0);";

    String wcreateParamAv = "CREATE TABLE Param_Av (Param_AvID TEXT NOT NULL, Param_Av_No TEXT NOT NULL, Param_Av_Det TEXT NOT NULL, Param_Av_Proc TEXT NOT NULL, Param_Av_Lnk TEXT NOT NULL );";

    String wcreateUsersHab = "CREATE TABLE User_Hab (User_HabID INTEGER NOT NULL, User_Hab_UserID INTEGER NOT NULL, User_Hab_Param_HabID INTEGER NOT NULL, User_Hab_MaintPrev INTEGER NOT NULL, User_Hab_Install INTEGER NOT NULL, User_Hab_MaintCorrect INTEGER NOT NULL, User_Hab_Ordre INTEGER NOT NULL DEFAULT 0);";

    String wcreateUsers = "CREATE TABLE Users ("
    ...
    String wcreateIntermissions = "CREATE TABLE InterMissions (InterMissionId int(11) NOT NULL,"
    ...
    String wcreatePlanning = "CREATE TABLE Planning (PlanningId int(11) NOT NULL,"
    ...
    String wcreatePlanningIntervention = "CREATE TABLE Planning_Intervention ("
    ...
    String wcreateParcimgs = "CREATE TABLE Parc_Imgs (Parc_Imgid  INTEGER PRIMARY KEY AUTOINCREMENT,Parc_Imgs_ParcsId  INTEGER, Parc_Imgs_Type  INTEGER, Parc_Imgs_Principale  INTEGER, Parc_Imgs_Date  TEXT, Parc_Imgs_Data  TEXT, Parc_Imgs_Path varchar(512) NOT NULL DEFAULT '')";

    String wcreateParcsEnt = "CREATE TABLE Parcs_Ent (ParcsId  INTEGER PRIMARY KEY AUTOINCREMENT"
        ", Parcs_order INTEGER"
    ...
    String wcreateParcsDesc = "CREATE TABLE Parcs_Desc (ParcsDescId  INTEGER PRIMARY KEY AUTOINCREMENT"
    ...
    String wcreateParcsDescIndex = "CREATE INDEX ParcsDesc_ParcsId ON Parcs_Desc(ParcsDesc_ParcsId)";

    String wcreateParcsArt = "CREATE TABLE Parcs_Art (ParcsArtId  INTEGER PRIMARY KEY AUTOINCREMENT"
    ...
    String wcreateNf074HistoNormes =
    ...
    String wcreateNf074MixteProduit =
    ...
    String wcreateNf074PiecesActions =
    ...
    String wcreateNf074PiecesDetInc =
    ...
    String wcreateRiaGammes = "CREATE TABLE RIA_Gammes (RIA_GammesId int(11) NOT NULL, RIA_Gammes_DESC varchar(128) NOT NULL DEFAULT '',RIA_Gammes_FAB varchar(128) NOT NULL DEFAULT '',RIA_Gammes_TYPE varchar(128) NOT NULL DEFAULT '',RIA_Gammes_ARM varchar(128) NOT NULL DEFAULT '',RIA_Gammes_INOX varchar(128) NOT NULL DEFAULT '',RIA_Gammes_PDT varchar(128) NOT NULL DEFAULT '',RIA_Gammes_DIAM varchar(128) NOT NULL DEFAULT '',RIA_Gammes_LONG varchar(128) NOT NULL DEFAULT '',RIA_Gammes_DIF varchar(128) NOT NULL DEFAULT '',RIA_Gammes_DISP varchar(128) NOT NULL DEFAULT '',RIA_Gammes_PREM varchar(128) NOT NULL DEFAULT '',RIA_Gammes_REF varchar(128) NOT NULL DEFAULT '',RIA_Gammes_NCERT varchar(128) NOT NULL DEFAULT '')";



    String wcreateArticlesFamEbp = "CREATE TABLE Articles_Fam_Ebp ("
    ...
    String wcreateArticlesEbp = "CREATE TABLE Articles_Ebp ("
    ...
    String wcreateArticlesimgEbp = "CREATE TABLE ArticlesImg_Ebp ("
    ...
    String wcreateDclEnt = "CREATE TABLE DCL_Ent ("
    ...
    String wcreateDclDet = "CREATE TABLE DCL_Det ("
    ...
    database = openDatabase(
      ...
      onCreate: (db, version) async {
        await db.execute(wcreateParamAv);
        await db.execute(wcreateUsersDesc);
        await db.execute(wcreateUsersHab);
        await db.execute(wcreateParamParam);
        await db.execute(wcreateParamSaisie);
        await db.execute(wcreateParamSaisieParam);
        await db.execute(wcreateUsers);
        await db.execute(wcreateClients);
        await db.execute(wcreateAdresses);
        await db.execute(wcreateContacts);

        await db.execute(wcreatePlanning);

        await db.execute(wcreateGroupes);
        await db.execute(wcreateSites);
        await db.execute(wcreateZones);

        await db.execute(wcreatePlanningIntervention);
        await db.execute(wcreateIntervention);
        await db.execute(wcreateIntermissions);
        await db.execute(wcreateParcimgs);
        await db.execute(wcreateParcsEnt);
        await db.execute(wcreateParcsDesc);
        await db.execute(wcreateParcsDescIndex);
        await db.execute(wcreateParcsArt);
        await db.execute(wcreateNf074Avertissements);
        await db.execute(wcreateNf074Gammes);
        await db.execute(wcreateNf074HistoNormes);
        await db.execute(wcreateNf074MixteProduit);
        await db.execute(wcreateNf074PiecesActions);
        await db.execute(wcreateNf074PiecesDet);
        await db.execute(wcreateNf074PiecesDetInc);
        await db.execute(wcreateArticlesEbp);
        await db.execute(wcreateArticlesFamEbp);
        await db.execute(wcreateArticlesimgEbp);
        await db.execute(wcreateRiaGammes);

        await db.execute(wcreateDclEnt);
        await db.execute(wcreateDclDet);
      },
  ...
  static Future<void> inserUser_Hab(User_Hab wuserHab) async {
    final db = await DbTools.database;
    int? repid = await db.insert("User_Hab", wuserHab.toMap());
    gLastID = repid!;
  }
  ...
  static Future<void> inserUser_Desc(User_Desc wuserDesc) async {
    final db = await DbTools.database;
    int? repid = await db.insert("User_Desc", wuserDesc.toMap());
    gLastID = repid!;
  }
  ...
  static Future<void> inserParam_Av(SrvParam_Av wparamAv) async {
    final db = await DbTools.database;
    int? repid = await db.insert("Param_Av", wparamAv.toMap());
    gLastID = repid!;
  }
  ...
  static genParam() {
    ...
    for (int i = 0; i < Srv_DbTools.ListParam_Param_Civ.length; i++) {
      ...
      if (wparamParam.Param_Param_Text == "C") Srv_DbTools.ListParam_ParamCiv.add(wparamParam.Param_Param_ID);
    }
    ...
    for (int i = 0; i < Srv_DbTools.ListParam_Param_Civ.length; i++) {
      Param_Param wparamParam = Srv_DbTools.ListParam_Param_Civ[i];
      if (wparamParam.Param_Param_Text != "C") Srv_DbTools.ListParam_ParamForme.add(wparamParam.Param_Param_ID);
    }
  }

  static Future<void> inserParam_Param(Param_Param wparamParam) async {
    final db = await DbTools.database;
    int? repid = await db.insert("Param_Param", wparamParam.toMap());
    gLastID = repid!;
  }
...
//      print(" getParam_Saisie_ParamAll IMPORT ${maps[i]["Param_Saisie_Param_Id"]} ${maps[i]["Param_Saisie_Param_Label"]} ${maps[i]["Param_Saisie_Param_Init"]}");
  ...
  static Future<void> inserParam_Saisie_Param(Param_Saisie_Param wparamSaisieParam) async {
    final db = await DbTools.database;
    int? repid = await db.insert("Param_Saisie_Param", wparamSaisieParam.toMap());
    gLastID = repid!;
  }
  ...
  static Future<bool> getParam_Saisie_Base(String paramSaisieType) async {
    final db = await database;
    final List<Map<String, dynamic>> maps = await db.query("Param_Saisie", where: "Param_Saisie_Organe = 'Base' AND Param_Saisie_Type = '$paramSaisieType'", orderBy: "Param_Saisie_Organe, Param_Saisie_Type, Param_Saisie_Ordre,Param_Saisie_ID");
    ...
    if (Srv_DbTools.ListParam_Saisie_Base.isNotEmpty) {
      int i = 1;
      for (var element in Srv_DbTools.ListParam_Saisie_Base) {
  ...
  static Future<bool> getParam_Saisie(String paramSaisieOrgane, String paramSaisieType) async {
    final db = await database;
    final List<Map<String, dynamic>> maps = await db.query("Param_Saisie", where: "Param_Saisie_Organe = '$paramSaisieOrgane' AND Param_Saisie_Type = '$paramSaisieType'", orderBy: "Param_Saisie_Organe, Param_Saisie_Type, Param_Saisie_Ordre,Param_Saisie_ID");
    ...
    if (Srv_DbTools.ListParam_Saisie.isNotEmpty) {
      int i = 1;
      for (var element in Srv_DbTools.ListParam_Saisie) {
        element.Param_Saisie_Ordre = i++;
        setParam_Saisie(element);
      }
      return true;
  ...
  static Future<void> setParam_Saisie(Param_Saisie wparamSaisie) async {
    final db = await DbTools.database;
    int? repid = await db.update(
      "Param_Saisie",
      wparamSaisie.toMap(),
      where: "Param_SaisieId = ?",
      whereArgs: [wparamSaisie.Param_SaisieId],
    );
    gLastID = repid!;
  }

  static Future<void> inserParam_Saisie(Param_Saisie wparamSaisie) async {
    final db = await DbTools.database;
    int? repid = await db.insert("Param_Saisie", wparamSaisie.toMap());
    gLastID = repid!;
  }
...
//      print("***********>>>   getParcs_DescInter maps ${maps[i]["${wRef}"]}");
      Srv_DbTools.ListParam_Saisie_Param.add(Param_Saisie_Param(i, "FAB", i, maps[i][wRef], maps[i][wRef], maps[i][wRef], false, false, const SizedBox(), "Noir"));
    });
  }
  ...
  static Future getRIA_Gammes_TYPE() async {
    ...
    return List.generate(maps.length, (i) {
//      print("***********>>>   getParcs_DescInter maps ${maps[i]["${wRef}"]}");
      Srv_DbTools.ListParam_Saisie_Param.add(Param_Saisie_Param(i, "TYPE", i, maps[i][wRef], maps[i][wRef], maps[i][wRef], false, false, const SizedBox(), "Noir"));
    });
  }
  ...
  static Future getRIA_Gammes_ARM() async {
    ...
    return List.generate(maps.length, (i) {
//      print("***********>>>   getParcs_DescInter maps ${maps[i]["${wRef}"]}");
      Srv_DbTools.ListParam_Saisie_Param.add(Param_Saisie_Param(i, "ARM", i, maps[i][wRef], maps[i][wRef], maps[i][wRef], false, false, const SizedBox(), "Noir"));
    });
  }
  ...
  static Future getRIA_Gammes_INOX() async {
    ...
    return List.generate(maps.length, (i) {
//      print("***********>>>   getParcs_DescInter maps ${maps[i]["${wRef}"]}");
      Srv_DbTools.ListParam_Saisie_Param.add(Param_Saisie_Param(i, "INOX", i, maps[i][wRef], maps[i][wRef], maps[i][wRef], false, false, const SizedBox(), "Noir"));
    });
  }
  ...
  static Future getRIA_Gammes_DIAM() async {
    ...
    return List.generate(maps.length, (i) {
//      print("***********>>>   getParcs_DescInter maps ${maps[i]["${wRef}"]}");
      Srv_DbTools.ListParam_Saisie_Param.add(Param_Saisie_Param(i, "DIAM", i, maps[i][wRef], maps[i][wRef], maps[i][wRef], false, false, const SizedBox(), "Noir"));
    });
  }
...
//  SELECT RIA_Gammes_REF, RIA_Gammes_NCERT FROM RIA_Gammes WHERE RIA_Gammes_DESC = 'RIA' AND RIA_Gammes_FAB = 'RH-Mobiak SA/GEM' AND RIA_Gammes_TYPE = 'Pivotant' AND RIA_Gammes_ARM = 'Oui' AND RIA_Gammes_INOX = 'Non' AND RIA_Gammes_DIAM = '33/12mm' AND RIA_Gammes_LONG = '20' AND RIA_Gammes_DIF = 'DMFA' AND RIA_Gammes_DISP = 'DMFA' GROUP BY RIA_Gammes_REF, RIA_Gammes_NCERT ORDER BY RIA_Gammes_REF, RIA_Gammes_NCERT;
  ...
  static Future getNF074_Gammes_Decs() async {
    ...
    return List.generate(maps.length, (i) {
      Srv_DbTools.ListParam_Saisie_Param.add(Param_Saisie_Param(i, "DESC", i, maps[i]["NF074_Gammes_DESC"], maps[i]["NF074_Gammes_DESC"], maps[i]["NF074_Gammes_DESC"], false, false, const SizedBox(), "Noir"));
    });
  }
...
//      print("***********>>>   getNF074_Gammes_FAB maps ${maps[i]["NF074_Gammes_FAB"]}");
      Srv_DbTools.ListParam_Saisie_Param.add(Param_Saisie_Param(i, "FAB", i, maps[i]["NF074_Gammes_FAB"], maps[i]["NF074_Gammes_FAB"], maps[i]["NF074_Gammes_FAB"], false, false, const SizedBox(), "Noir"));
    });
  }
  ...
  static Future getNF074_Gammes_PRS() async {
    ...
    return List.generate(maps.length, (i) {
//      print("***********>>>   getParcs_DescInter maps ${maps[i]["${wRef}"]}");
      Srv_DbTools.ListParam_Saisie_Param.add(Param_Saisie_Param(i, "DESC", i, maps[i][wRef], maps[i][wRef], maps[i][wRef], false, false, const SizedBox(), "Noir"));
    });
  }
...
//    print("***********>>>   getNF074_Gammes_POIDS wSql ${wSql}");
  ...
  static Future<void> insertNF074_Gammes(NF074_Gammes nf074Gammes) async {
    final db = await DbTools.database;
    int? repid = await db.insert("NF074_Gammes", nf074Gammes.toMap());
    gLastID = repid!;
  }
  ...
  static Future<void> insertRIA_Gammes(RIA_Gammes riaGammes) async {
    final db = await DbTools.database;
    int? repid = await db.insert("RIA_Gammes", riaGammes.toMap());
    gLastID = repid!;
  }
  ...
  static Future<void> insertNF074_Histo_Normes(NF074_Histo_Normes nf074HistoNormes) async {
    final db = await DbTools.database;
    int? repid = await db.insert("NF074_Histo_Normes", nf074HistoNormes.toMap());
    gLastID = repid!;
  }
  ...
  static Future<List<NF074_Pieces_Det>> getNF074_Pieces_Det_In(String wType) async {
    ...
    if (wType.contains("Inst")) {
      if (selTypeVerif.isNotEmpty) selTypeVerif += " OR ";
...
//    gColors.printWrapped("≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈ getNF074_Pieces_Det_In maps ${maps}");
  ...
  static Future<void> insertNF074_Pieces_Det(NF074_Pieces_Det nf074PiecesDet) async {
    final db = await DbTools.database;
    int? repid = await db.insert("NF074_Pieces_Det", nf074PiecesDet.toMap());
    gLastID = repid!;
  }
  ...
  static Future<List<NF074_Pieces_Det_Inc>> getNF074_Pieces_Det_Inc_In(String wType) async {
    ...
    String wpoidsLib = Srv_DbTools.POIDS_Lib;
    String wUNIT = "";
    if (wpoidsLib.contains("Kilos")) {
      wUNIT = "Kg";
      wpoidsLib = wpoidsLib.replaceAll("Kilos", "");
      //print("≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈ wPOIDS_Lib KG ${wPOIDS_Lib}");
    }
    if (wpoidsLib.contains("Litres")) {
      wUNIT = "L";
      wpoidsLib = wpoidsLib.replaceAll("Litres", "");
      //print("≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈ wPOIDS_Lib L ${wPOIDS_Lib}");
    }
    wpoidsLib.replaceAll(" ", "");

    //print("≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈ wPOIDS_Lib ${wPOIDS_Lib}");

    int wPOIDS = int.tryParse(wpoidsLib) ?? 0;
  ...
  static Future<void> insertNF074_Pieces_Det_Inc(NF074_Pieces_Det_Inc nf074PiecesDetInc) async {
    final db = await DbTools.database;
    int? repid = await db.insert("NF074_Pieces_Det_Inc", nf074PiecesDetInc.toMap());
    gLastID = repid!;
  }
...
//    print("≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈≈ wPOIDS_Lib ${wPOIDS_Lib}");
  ...
  static Future<void> insertNF074_Mixte_Produit(NF074_Mixte_Produit nf074MixteProduit) async {
    final db = await DbTools.database;
    int? repid = await db.insert("NF074_Mixte_Produit", nf074MixteProduit.toMap());
    gLastID = repid!;
  }
  ...
  static Future<List<NF074_Pieces_Actions>> getNF074_Pieces_Actions_In(String wType) async {
    ...
    String selpdtPoidsPrs = "(NF074_Pieces_Actions_PDT = '${Srv_DbTools.PDT_Lib}' AND NF074_Pieces_Actions_POIDS = '${Srv_DbTools.POIDS_Lib}' )";

    String ipoidsLib = Srv_DbTools.POIDS_Lib.replaceAll(RegExp(r'[^0-9]'), '');
    String selPOIDS = "";
    if (ipoidsLib.trim().isNotEmpty) {
      selPOIDS = "OR (NF074_Pieces_Actions_POIDS LIKE '%A :%' AND $ipoidsLib <=2) OR (NF074_Pieces_Actions_POIDS LIKE '%B :%'  AND $ipoidsLib > 2 AND $ipoidsLib < 20) OR (NF074_Pieces_Actions_POIDS LIKE '%C :%' AND $ipoidsLib >= 20)";
    }
    ...
    if (selTypeVerif.isEmpty) {
      ...
      selSQL = "$selBase ($selTypeVerif)  AND ( $selDESC OR $selpdtPoidsPrs $selPOIDS)  ";
    }
  ...
  static Future<void> insertNF074_Pieces_Actions(NF074_Pieces_Actions nf074PiecesActions) async {
    final db = await DbTools.database;
    int? repid = await db.insert("NF074_Pieces_Actions", nf074PiecesActions.toMap());
    gLastID = repid!;
  }
  ...
  static Future<bool> getAdresseClientType(int ClientID, String Type) async {
    ...
    if (Srv_DbTools.ListAdressesearchresult.isNotEmpty) {
...
//    print("inserAdresse ${wAdresse.toMap()}");
  ...
  static Future<bool> getContactClientAdrType(int ClientID, int AdresseId, String Type) async {
    ...
    if (Srv_DbTools.ListContact.isNotEmpty) {
...
//    final List<Map<String, dynamic>> maps = await db.query("Planning", orderBy: "PlanningId ASC");
  ...
  static Future<void> inserPlanning_Intervention(Planning_Intervention wplanningIntervention) async {
    final db = await DbTools.database;
//    print("wPlanning_Intervention.toMap() ${wPlanning_Intervention.toMap()}");
    int? repid = await db.insert("Planning_Intervention", wplanningIntervention.toMap());
    gLastID = repid!;
  }
    ...
    for (var element in Srv_DbTools.ListParam_ParamAll) {
      if (element.Param_Param_Type.compareTo("Type_Organe") == 0) {
        if (element.Param_Param_ID.compareTo("Base") != 0) {
          Parc_Ent_Count wparcEntCount = Parc_Ent_Count();
          wparcEntCount.ParamType = element.Param_Param_ID;
          wparcEntCount.ParamTypeOg = element.Param_Param_Text;
          wparcEntCount.ParamTypeOg_count = 0;
          DbTools.lParc_Ent_CountAll.add(wparcEntCount);
        }
      }
    }

    for (var element in DbTools.glfParcs_Ent) {
...
//    print("getParcs_EntAll Parcs_Ent.length ${maps.length}");
  ...
  static Future<List<Parc_Ent>> getParcs_Ent(int parcsInterventionid) async {
    final db = await database;
    final List<Map<String, dynamic>> maps = await db.query("Parcs_Ent", orderBy: "Parcs_order ASC, Parcs_UUID_Parent ASC", where: '"Parcs_InterventionId" = $parcsInterventionid', whereArgs: []);
    print("getParcs_Ent Parcs_Ent.length A ${maps.length} $parcsInterventionid");
    return List.generate(maps.length, (i) {
      return Parc_Ent.fromMap(maps[i]);
    });
  }

  static Future<Parc_Ent> getParcs_Ent_Parcs_UUID_Child(String parcsUuid) async {
    final db = await database;
    final List<Map<String, dynamic>> maps = await db.query("Parcs_Ent", orderBy: "Parcs_order ASC", where: '"Parcs_UUID_Parent" = "$parcsUuid"', whereArgs: []);
//    print("getParcs_Ent_Parcs_UUID_Child Parcs_Ent.length ${maps.length} ${Parcs_UUID}");
  ...
  static Future<Parc_Ent> getParcs_Ent_Parcs_UUID_Parent(String parcsUuid) async {
    final db = await database;
    final List<Map<String, dynamic>> maps = await db.query("Parcs_Ent", orderBy: "Parcs_order ASC", where: '"Parcs_UUID_Parent" = "$parcsUuid"', whereArgs: []);
//    print("getParcs_Ent_Parcs_UUID_Child Parcs_Ent.length ${maps.length} ${Parcs_UUID}");
    if (maps.isNotEmpty) {
  ...
  static Future<List<Parc_Ent>> getParcs_Ent_Upd(int parcsInterventionid) async {
    final db = await database;
    final List<Map<String, dynamic>> maps = await db.query("Parcs_Ent", where: '"Parcs_InterventionId" = $parcsInterventionid AND Parcs_Update > 0', orderBy: "Parcs_order , Parcs_UUID_Parent", whereArgs: []);
    print("getParcs_Ent Parcs_Ent.length B ${maps.length} $parcsInterventionid");
    return List.generate(maps.length, (i) {
  ...
  static Future<void> moveParc_EntNew(int aparcId, int Sens) async {
    ...
    var wparcsEnt = glfParcs_Ent.where((element) => element.ParcsId == aparcId);
    if (wparcsEnt.isNotEmpty) aparSel = wparcsEnt.first;

    if (aparSel.Parcs_UUID_Parent!.isNotEmpty) {
      // Recup Sel wParcs_Ent parent si enfant
      var wparcsEnt = glfParcs_Ent.where((element) => element.Parcs_UUID!.compareTo(aparSel.Parcs_UUID_Parent!) == 0);
      if (wparcsEnt.isNotEmpty) aparSel = wparcsEnt.first;
    }

    // creation liste sans enfants
    var wglfparcsEnt = glfParcs_Ent.where((element) => element.Parcs_UUID_Parent!.isEmpty);
    ...
    bool trv = false;
    if (Sens == -1) {
      for (int i = 0; i < wglfparcsEnt.length; i++) {
        Parc_Ent element = wglfparcsEnt.elementAt(i);
      ...
      for (int i = wglfparcsEnt.length - 1; i >= 0; i--) {
        Parc_Ent element = wglfparcsEnt.elementAt(i);
        if (element.Parcs_order! > aparSel.Parcs_order!) {
          parc = element;
          trv = true;
    ...
    if (trv) {
      ...
      int saveparcparcsOrder = parc.Parcs_order!;
      parc.Parcs_order = aparSel.Parcs_order!;
      updateParc_Ent_Ordre(parc);

      aparSel.Parcs_order = saveparcparcsOrder;
      updateParc_Ent_Ordre(aparSel);

      for (int i = wglfparcsEnt.length - 1; i >= 0; i--) {
        Parc_Ent element = wglfparcsEnt.elementAt(i);
        Parc_Ent wparcEnt = await DbTools.getParcs_Ent_Parcs_UUID_Child(element.Parcs_UUID!);
        wparcEnt.Parcs_order = element.Parcs_order;
        updateParc_Ent_Ordre(wparcEnt);
      }
  ...
  static Future<void> moveParc_Ent(int aparcId, int Sens) async {
    ...
    aparc.Parcs_order = saveparcparcsOrder;
  ...
  static int EntSortOrderComparison(Parc_Ent a, Parc_Ent b) {
    int parcEnta = a.Parcs_order!;
    int parcEntb = b.Parcs_order!;
    if (parcEnta < parcEntb) {
      return -1;
    } else if (parcEnta > parcEntb) {
      return 1;
    } else {
      return 0;
    }
  ...
  static Future<void> moveParc_EntID2IDUp(int aIdA, int aIdB, int aOrdreA, int aOrdreB) async {
    ...
    int saveparcparcsOrder = 0;

    List<Parc_Ent> wparcsEnt = [];
    // wParcs_Ent.addAll(lParcs_Ent);
    for (int i = 0; i < lParcs_Ent.length; i++) {
      Parc_Ent wparcEnt = lParcs_Ent[i];
      if (wparcEnt.Parcs_UUID_Parent!.isEmpty) {
        wparcsEnt.add(wparcEnt);
      }
    }

    wparcsEnt.sort(EntSortOrderComparison);
    int EltA = 0;
...
//      print("wParc_Ent ${wParc_Ent.ParcsId} ${wParc_Ent.Parcs_order} ${wParc_Ent.Parcs_UUID} ${wParc_Ent.Parcs_UUID_Parent}");
      ...
      if (wparcEntchild.Parcs_order! >= 0) {
        ...
        wparcEntchild.Parcs_order = wparcEnt.Parcs_order;
      }
      await updateParc_Ent_Ordre(wparcEntchild);
    }
...
//      print("wParc_Ent ${wParc_Ent.ParcsId} ${wParc_Ent.Parcs_order} ${wParc_Ent.Parcs_UUID} ${wParc_Ent.Parcs_UUID_Parent}");
  ...
  static Future<void> updateParc_Ent(Parc_Ent parc) async {
    ...
    String wSlq = 'UPDATE Parcs_Ent SET '
            'Parcs_order = ${parc.Parcs_order}, ' 'Parcs_InterventionId = ${parc.Parcs_InterventionId}, ' 'Parcs_Type = "${parc.Parcs_Type}", ' 'Parcs_Date_Rev = "${parc.Parcs_Date_Rev}", ' 'Parcs_QRCode = "${parc.Parcs_QRCode}", ' +
  ...
  static Future<void> updateParc_Ent_Timer(int ParcsId, int parcsInterventionTimer) async {
//    print("updateParc_Ent_Update");
    final db = await database;
    String wSlq = "UPDATE Parcs_Ent SET Parcs_Intervention_Timer = $parcsInterventionTimer, Parcs_Update = 1 WHERE ParcsId = $ParcsId";
    //  print("updateParc_Ent_Update ${wSlq}");
    await db.execute(wSlq);
  }

  static Future<void> updateParc_Ent_Update(int ParcsId, int parcsUpdate) async {
    print("updateParc_Ent_Update");
    final db = await database;
    String wSlq = "UPDATE Parcs_Ent SET Parcs_Update = $parcsUpdate WHERE ParcsId = $ParcsId";
    print("updateParc_Ent_Update B $wSlq");
    await db.execute(wSlq);
  }

  static Future<int> Parc_Ent_GetLastOrder() async {
    List<Parc_Ent> wparcsEnt = await DbTools.getParcs_Ent(Srv_DbTools.gIntervention.InterventionId);

    int wRet = 0;

    for (int j = 0; j < wparcsEnt.length; j++) {
      Parc_Ent wparcEnt = wparcsEnt[j];
      wRet = max(wRet, wparcEnt.Parcs_order!);
    }
...
//    List<Parc_Ent> wParcs_Ent = await DbTools.getParcs_EntAll();
    ...
    for (int j = 0; j < wparcsEnt.length; j++) {
      ...
      wparcEnt.Parcs_order = o;
      await DbTools.updateParc_Ent_Ordre(wparcEnt);
      DbTools.glfParcs_Ent.add(wparcEnt);
    }
  }

  static Future<void> Parc_Ent_List() async {
    List<Parc_Ent> wparcsEnt = await DbTools.getParcs_Ent(Srv_DbTools.gIntervention.InterventionId);
    print("Parc_Ent_List wParcs_Ent lenght ${wparcsEnt.length}");
    for (int j = 0; j < wparcsEnt.length; j++) {
...
//    print("updateParc_Ent_Action <<<<<< ${parc.Action}");
  ...
  static Future<void> insertParc_Ent(Parc_Ent wparcEnt) async {
    final db = await DbTools.database;
    print("insertParc_Ent wParc_Ent ${wparcEnt.Parcs_InterventionId}");
    wparcEnt.Parcs_Update = 1;

    var uuid = const Uuid();
    String uuidv1 = uuid.v1();
    print("insertParc_Ent uuidv1 $uuidv1");
    wparcEnt.Parcs_UUID = uuidv1;

    int? repid = await db.insert("Parcs_Ent", wparcEnt.toMap());
    print("insertParc_Ent repid $repid");

    gLastID = repid!;
  }

  static Future<void> insertParc_Ent_Srv(Parc_Ent_Srv parcEnt) async {
    final db = await DbTools.database;
//    print("insertParc_Ent");
    gLastID = await db.insert("Parcs_Ent", parcEnt.toMap());
//    print("insertParc_Ent ${gLastID}");
  ...
  static Future<void> deleteParc_EntInter(int aparcsInterventionid) async {
    final db = await database;
    await db.delete(
      "Parcs_Ent",
      where: "Parcs_InterventionId = ?",
      whereArgs: [aparcsInterventionid],
    );
  }
  ...
  static Future<List<Parc_Desc>> getParcs_DescInter(int parcsInterventionid) async {
    final db = await database;
    final List<Map<String, dynamic>> maps = await db.rawQuery('SELECT Parcs_Desc.* FROM Parcs_Desc, Parcs_Ent  WHERE ParcsDesc_ParcsId = ParcsId AND Parcs_InterventionId = ? ', [parcsInterventionid]);
...
//    print("♠︎♠︎♠︎♠︎♠>>>   getParcs_DescInter maps ${maps[i]}");
  ...
  static Future<List<Parc_Desc>> getParcs_Desc(int parcsdescParcsid) async {
    final db = await database;
    String wSql = "SELECT Parcs_Desc.* FROM Parcs_Desc  WHERE ParcsDesc_ParcsId = $parcsdescParcsid ";
    // print("♠︎♠︎♠︎♠︎♠︎ getParcs_Desc ${wSql}");
    final List<Map<String, dynamic>> maps = await db.rawQuery('SELECT Parcs_Desc.* FROM Parcs_Desc  WHERE ParcsDesc_ParcsId = ? ', [parcsdescParcsid]);
    return List.generate(maps.length, (i) {
      return Parc_Desc.fromMap(maps[i]);
    });
  }

  static Parc_Desc getParcs_Desc_Id_Type(int parcsdescParcsid, String paramSaisieId) {
//    print("getParcs_Desc_Id_Type");
    Parc_Desc wparcDesc = Parc_Desc.Parc_DescInit(parcsdescParcsid, paramSaisieId);
...
//      print("♠︎♠︎♠︎♠︎♠︎ getParcs_Desc_Id_Type element ${element.toMap()}");
      if (element.ParcsDesc_ParcsId == parcsdescParcsid) {
        if (element.ParcsDesc_Type!.compareTo(paramSaisieId) == 0) {
          wparcDesc = element;
          return;
        }
      }
  ...
  static Future<Parc_Desc> getParcs_Desc_Id_Type_Add(int parcsdescParcsid, parcsdescType) async {
    Parc_Desc wparcDesc = Parc_Desc.Parc_DescInit(parcsdescParcsid, parcsdescType);
    for (int i = 0; i < glfParcs_Desc.length; i++) {
      ...
      if (element.ParcsDesc_ParcsId == parcsdescParcsid) {
        if (element.ParcsDesc_Type!.compareTo(parcsdescType) == 0) {
          wparcDesc = element;
          break;
        }
      }
    ...
    if (wparcDesc.ParcsDescId == -1) {
      ...
      final db = await database;
      int? repid = await db.insert("Parcs_Desc", wparcDesc.toMapInsert());
    }
    return wparcDesc;
  }
...
//    if (isEq) return isEq;
    ...
    for (int i = 0; i < Srv_DbTools.ListParam_Saisie.length; i++) {
      ...
      if (wparamSaisie.Param_Saisie_ID.compareTo(parc.ParcsDesc_Type!) == 0) {
        modifDesc = true;
      }
    }
...
//      if (element.ParcsDescId! > parc.ParcsDescId!) {
      if (element.ParcsDesc_ParcsId! == parc.ParcsDesc_ParcsId! && element.ParcsDescId! > parc.ParcsDescId!) {
        ...
        for (int i = 0; i < Srv_DbTools.ListParam_Saisie.length; i++) {
          Param_Saisie wparamSaisie = Srv_DbTools.ListParam_Saisie[i];
          if (wparamSaisie.Param_Saisie_ID.compareTo(element.ParcsDesc_Type!) == 0) {
            if (wparamSaisie.Param_Saisie_Type.compareTo("Desc") == 0) isDesc = true;
          }
        }
...
//          Srv_DbTools.getParam_Saisie_ParamMem_PRS();
  ...
  static Future<void> updateParc_Desc_NoRaz(Parc_Desc parcDesc, String InitLib) async {
    bool isEq = false;
    glfParcs_Desc.forEach((element) async {
      if (element.ParcsDescId! == parcDesc.ParcsDescId!) {
    ...
    int? repid = await db.update(
      ...
      parcDesc.toMap(),
      where: "ParcsDescId = ?",
      whereArgs: [parcDesc.ParcsDescId],
    );
  }

  static Future<void> insertParc_Desc(Parc_Desc parcDesc) async {
    print(">>>> insertParc_Desc A ${parcDesc.ParcsDescId} ${parcDesc.ParcsDesc_Lib} ");

    final db = await DbTools.database;
    int? repid = await db.insert("Parcs_Desc", parcDesc.toMap());
    print("insertParc_Desc $repid");
  }

  static Future<void> insertIntoParc_Desc(Parc_Desc aparcDesc) async {
    print(">>>> insertIntoParc_Desc A ${aparcDesc.toString()}");
  ...
  static Future<void> insertParc_Desc_Srv(Parc_Desc_Srv parcDesc) async {
    final db = await DbTools.database;
    int? repid = await db.insert("Parcs_Desc", parcDesc.toMap());
//    print("insertParc_Desc_Srv ${repid}");
  ...
  static Future<List<Parc_Art>> getParcs_ArtAll(int parcsartParcsid) async {
    List<Parc_Art> parcArtret = [];
    List<Parc_Art> parcArttmp = await DbTools.getParcs_Art(DbTools.gParc_Ent.ParcsId!, "V");
    parcArtret.addAll(parcArttmp);
    parcArttmp = await DbTools.getParcs_Art(DbTools.gParc_Ent.ParcsId!, "P");
    parcArtret.addAll(parcArttmp);
    parcArttmp = await DbTools.getParcs_Art(DbTools.gParc_Ent.ParcsId!, "M");
    parcArtret.addAll(parcArttmp);
    parcArttmp = await DbTools.getParcs_Art(DbTools.gParc_Ent.ParcsId!, "ES");
    parcArtret.addAll(parcArttmp);
    parcArttmp = await DbTools.getParcs_Art(DbTools.gParc_Ent.ParcsId!, "MS");
    parcArtret.addAll(parcArttmp);
    parcArttmp = await DbTools.getParcs_Art(DbTools.gParc_Ent.ParcsId!, "Mo");
    parcArtret.addAll(parcArttmp);
    parcArttmp = await DbTools.getParcs_Art(DbTools.gParc_Ent.ParcsId!, "Dn");
    parcArtret.addAll(parcArttmp);
    parcArttmp = await DbTools.getParcs_Art(DbTools.gParc_Ent.ParcsId!, "Serv");
    parcArtret.addAll(parcArttmp);

    return parcArtret;
  }

  static Future<List<Parc_Art>> getParcs_Art(int parcsartParcsid, String parcsartType) async {
    final db = await database;
    List<Map<String, dynamic>> maps = await db.rawQuery("SELECT Parcs_Art.* FROM Parcs_Art  WHERE ParcsArt_ParcsId = '$parcsartParcsid' and ParcsArt_Type = '$parcsartType' ORDER BY ParcsArt_Id");
    return List.generate(maps.length, (i) {
      return Parc_Art.fromMap(maps[i]);
    });
  }

  static Future<List<Parc_Art>> getParcs_Art_AllType(int parcsartParcsid) async {
    final db = await database;
    List<Map<String, dynamic>> maps = await db.rawQuery('SELECT Parcs_Art.* FROM Parcs_Art  WHERE ParcsArt_ParcsId = "$parcsartParcsid" and ParcsArt_lnk != "SO" ORDER BY ParcsArt_Id', []);
    return List.generate(maps.length, (i) {
      return Parc_Art.fromMap(maps[i]);
    });
  }

  static Future<List<Parc_Art>> getParcs_Art_AllTypeSynth(int parcsartParcsid) async {
    final db = await database;
    List<Map<String, dynamic>> maps = await db.rawQuery('SELECT Parcs_Art.* FROM Parcs_Art  WHERE ParcsArt_ParcsId = "$parcsartParcsid" and ParcsArt_Type != "ES" and ParcsArt_lnk != "SO" ORDER BY ParcsArt_Id', []);
    return List.generate(maps.length, (i) {
      return Parc_Art.fromMap(maps[i]);
    });
  }

  static Future<List<Parc_Art>> getParcs_ArtInter(int parcsInterventionid) async {
    final db = await database;

    String wTmp = "SELECT Parcs_Art.* FROM Parcs_Art, Parcs_Ent  WHERE ParcsArt_ParcsId = ParcsId AND Parcs_InterventionId = $parcsInterventionid ORDER BY Parcs_Art.ParcsArt_Id ASC";
...
//    print("getParcs_ArtInter maps.length ${maps.length}");
  ...
  static Future<List<Parc_Art>> getParcs_ArtInterSO(int parcsInterventionid) async {
    final db = await database;

    String wTmp = "SELECT Parcs_Art.* FROM Parcs_Art  WHERE ParcsArt_ParcsId  = $parcsInterventionid and ParcsArt_lnk = 'SO' ORDER BY Parcs_Art.ParcsArt_Id ASC";
...
//    print("getParcs_ArtInter maps.length ${maps.length}");
  ...
  static Future<List<Parc_Art>> getParcs_ArtInterSumBL(int parcsInterventionid) async {
    final db = await database;

    String wTmp = "SELECT Parcs_Art.*, SUM(ParcsArt_Qte) as Qte FROM Parcs_Art, Parcs_Ent WHERE ParcsArt_Fact != 'Devis' AND  ParcsArt_ParcsId = ParcsId AND Parcs_InterventionId = $parcsInterventionid and ParcsArt_Type != 'ES'  GROUP BY ParcsArt_Id,ParcsArt_Fact,ParcsArt_Livr ORDER BY Parcs_Art.ParcsArt_Id ASC;";
  ...
  static Future<List<Parc_Art>> getParcs_ArtInterSumDevis(int parcsInterventionid) async {
    final db = await database;
  ...
  static Future<List<Parc_Art>> getParcs_ArtSoDevis(int parcsInterventionid) async {
    final db = await database;

    String wTmp = "SELECT Parcs_Art.*, ParcsArt_Qte as Qte FROM Parcs_Art WHERE ParcsArt_Fact = 'Devis' and ParcsArt_lnk = 'SO' AND  ParcsArt_ParcsId =  $parcsInterventionid  ORDER BY Parcs_Art.ParcsArt_Id ASC;";
  ...
  static Future<List<Parc_Art>> getParcs_ArtSoBL(int parcsInterventionid) async {
    final db = await database;
  ...
  static Future<List<Parc_Art>> getParcs_ArtInterSum(int parcsInterventionid) async {
    final db = await database;

    String wTmp = "SELECT Parcs_Art.*, ParcsArt_Qte as Qte FROM Parcs_Art, Parcs_Ent WHERE ParcsArt_ParcsId = ParcsId AND Parcs_InterventionId = $parcsInterventionid ORDER BY Parcs_Art.ParcsArt_Id ASC;";
...
//    print("•••• setClient ${wRes}");
  ...
  static Future<void> insertParc_Art(Parc_Art parcArt) async {
    parcArt.ParcsArtId = null;
    final db = await DbTools.database;
    int? repid = await db.insert("Parcs_Art", parcArt.toMap());
    print(">>>>>>>>>>> insertParc_Art db.insert repid $repid");
  }

  static Future<void> insertParc_Art_Srv(Parc_Art_Srv parcArt) async {
    parcArt.ParcsArtId = null;
    final db = await DbTools.database;
    int? repid = await db.insert("Parcs_Art", parcArt.toMap());
  }
  ...
  static Future<void> deleteParc_Art_ParcsArt_ParcsId(int parcsartParcsid) async {
    final db = await database;
    String wTmp = "DELETE FROM Parcs_Art WHERE ParcsArt_ParcsId = $parcsartParcsid AND (ParcsArt_lnk = 'L' OR ParcsArt_Type = 'ES' OR ParcsArt_Type = 'MS')";
  ...
  static Future<void> insertParc_Img(Parc_Img parcImg) async {
    List<Parc_Img> wparcImgs = [];
    wparcImgs = await getParc_Imgs(parcImg.Parc_Imgs_ParcsId!, parcImg.Parc_Imgs_Type!);

    wparcImgs.forEach((element) async {
      print("parc_Img.Parc_Imgid ${parcImg.Parc_Imgid}");
      if (parcImg.Parc_Imgid != null) await deleteParc_Img(parcImg.Parc_Imgid!, parcImg.Parc_Imgs_Type!);
    });

    final db = await DbTools.database;
    int? repid = await db.insert("Parc_Imgs", parcImg.toMap());
    print("insertParc_Img $repid parc_Img.toMap() ${parcImg.toMap()}");
  }

  static Future<void> insertParc_Img_Srv(Parc_Imgs_Srv parcImg) async {
    parcImg.Parc_Imgid = null;
    final db = await DbTools.database;
    int? repid = await db.insert("Parc_Imgs", parcImg.toMap());
  }

  static Future<void> setParc_Img(Parc_Img parcImg) async {
    final db = await DbTools.database;
    int? repid = await db.update(
      "Parc_Imgs",
      parcImg.toMap(),
      where: "Parc_Imgid = ?",
      whereArgs: [parcImg.Parc_Imgid],
    );
    gLastID = repid!;
  }
  ...
  static Future<List<Parc_Img>> getParcs_ImgInter(int parcsInterventionid) async {
    final db = await database;

    String wTmp = "SELECT Parc_Imgs.* FROM Parc_Imgs, Parcs_Ent  WHERE Parc_Imgs_ParcsId = ParcsId AND Parcs_InterventionId = $parcsInterventionid ORDER BY Parc_Imgs.Parc_Imgid ASC";
...
//    print("getParcs_ImgInter maps.length ${maps.length}");
  ...
  static Future<List<DCL_Ent>> getDCL_Ent_DCL_Ent_InterventionId(int dclEntInterventionid) async {
    final db = await database;
    final List<Map<String, dynamic>> maps = await db.query("DCL_Ent", orderBy: "DCL_EntId ASC", where: "DCL_Ent_InterventionId = $dclEntInterventionid");
    return List.generate(maps.length, (i) {
      return DCL_Ent.fromMap(maps[i]);
    });
  }

  static Future<void> inserDCL_Ent(DCL_Ent wdclEnt) async {
    final db = await DbTools.database;
    int? repid = await db.insert("DCL_Ent", wdclEnt.toMapInsert());
    gLastID = repid!;
  }

  static Future<void> updateDCL_EntID(DCL_Ent wdclEnt, int OldID) async {
    final db = await DbTools.database;
    int? repid = await db.update("DCL_Ent", wdclEnt.toJson(), where: "DCL_EntId = ?", whereArgs: [OldID]);
  }

  static Future<void> updateDCL_Ent(DCL_Ent wdclEnt) async {
    final db = await DbTools.database;
    int? repid = await db.update("DCL_Ent", wdclEnt.toJson(), where: "DCL_EntId = ?", whereArgs: [wdclEnt.DCL_EntID]);
  }
  ...
  static Future<List<DCL_Det>> getDCL_DetID(int ID) async {
    ...
    return List.generate(maps.length, (i) {
      ...
      try {
        wdclDetCode = maps[i]['DCL_Det_Code'];
      } catch (e) {
        print(e);
      }
      return DCL_Det(
  ...
  static Future<void> inserDCL_Det(DCL_Det wdclDet) async {
    final db = await DbTools.database;
    int? repid = await db.insert("DCL_Det", wdclDet.toJson());
    gLastID = repid!;
  }

  static Future<void> updateDCL_DetID(DCL_Det wdclDet, int OldID) async {
    final db = await DbTools.database;
    int? repid = await db.update("DCL_Det", wdclDet.toJson(), where: "DCL_DetId = ?", whereArgs: [OldID]);
  }

  static Future<void> updateDCL_Det(DCL_Det wdclDet) async {
    final db = await DbTools.database;
    int? repid = await db.update("DCL_Det", wdclDet.toJson(), where: "DCL_DetId = ?", whereArgs: [wdclDet.DCL_DetID]);
  }
  ...
  static Future<void> AddPiece(int GrdBtnId, String grdbtnLabel) async {
    bool trv = false;
    int i = 0;
    for (var element in DbTools.lMaints) {
    ...
    if (!trv) {
      print("InkWell onTap B $i $GrdBtnId $grdbtnLabel");

      Maint wMaint1 = Maint(i, GrdBtnId, grdbtnLabel, 1, 1, false);
      DbTools.lMaints.add(wMaint1);
    }
  }

  static Future<void> AddPieceInter(int GrdBtnId, String grdbtnLabel) async {
    bool trv = false;
    int i = 0;
    for (var element in DbTools.lMaints) {
